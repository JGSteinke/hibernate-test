package de.hibernate.test.views.itemb;
...
import de.hibernate.test.data.entity.SampleAddress;
import de.hibernate.test.data.service.SampleAddressService;
import de.hibernate.test.views.MainLayout;
import java.util.Optional;
import org.springframework.data.domain.PageRequest;
import org.springframework.orm.ObjectOptimisticLockingFailureException;

@PageTitle("Item B")
@Route(value = "item/b/:sampleAddressID?/:action?(edit)", layout = MainLayout.class)
public class ItemBView extends Div implements BeforeEnterObserver {

    private final String SAMPLEADDRESS_ID = "sampleAddressID";
    private final String SAMPLEADDRESS_EDIT_ROUTE_TEMPLATE = "item/b/%s/edit";
    ...
    public ItemBView(SampleAddressService sampleAddressService) {
        this.sampleAddressService = sampleAddressService;
        addClassNames("item-b-view");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(ItemBView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (sampleAddressId.isPresent()) {
            ...
            if (sampleAddressFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(ItemBView.class);
            }
        }
    }
